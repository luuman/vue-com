...
<style lang="scss" scoped>
  ...
  .g-crop-image-principal {
    ...
    background-position: 0 0,size(10) size(10);
    background-size: size(21) size(21);
  }
  ...
  .image-aside {
    ...
    .image-wrap {
      ...
      -ms-user-select: none;
      user-select: none;
      box-shadow: 0 size(3) size(5) size(-2) rgba(0, 0, 0, 0.25);
  ...
  .crop-box {
    ...
    width: size(100);
    height: size(100);
    border: size(1) solid rgba(255, 255, 255, 0.95);
    &:after, &:before {
      content: '';
      display: block;
      opacity: 0;
    ...
    .g-resize {
      ...
      background-color: #fff;
      box-shadow: 0 size(2) size(4) size(-2) rgba(0, 0, 0, 0.25);
    }
  }
</style>
